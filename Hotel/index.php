...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:codeprojectsorg@gmail.com">jeweluddin@gmail.com</a></li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+94 733843998</p>
			<p class="contact-agile1"><strong>Address :</strong> Bengalure ,Karnataka</p>
